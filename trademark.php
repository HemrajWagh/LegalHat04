...
html {
            ...
            <div class="navbar  ">
                <!-- <div class="navbar"> -->
                    <div class="container">
                        ...
                        <button type="button" class="btn btn-navbar" data-bs-toggle="collapse" data-bs-target=".navbar-collapse"aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                            <i class="icon-menu"></i>
                        </button>
    <!--                     <button class="navbar-toggler " type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                          ...
                          <div class="navbar-collapse collapse pull-right">
                            <ul class="navbar-nav" id="top-navigation">
    ...
    <div class="container">
        <div class="row-fluid">
                ...
                <div class="col-md-3 col-sm-12">
                    <div class="card11 card-1 itemBox 2022" >
                      <a href="assets/doc/Financial_Results/Covering Letter along with Financial Results_Reg 52.pdf" target="_blank" style="text-decoration: none;" rel="noopener">
                        <h5 class="txtshadow zoom-in">COPYRIGHT REGISTRATION</h5>
                    </a>  
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-12">
                <div class="card11 card-1 itemBox 2022" >
                    <a href="assets/doc/Financial_Results/Covering Letter along with Financial Results.pdf" target="_blank" style="text-decoration: none;" rel="noopener">
                        <h5 class="txtshadow zoom-in">DESIGN REGISTRATION</h5>
                    </a>  
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-12">
                <div class="card11 card-1 itemBox 2022" >
                    <a href="assets/doc/Financial_Results/Covering Letter_Reg 52_Financial Results_organized_compressed.pdf" target="_blank" style="text-decoration: none;" rel="noopener">
                        <h5 class="txtshadow zoom-in">PATENT REGISTRATION</h5>
                    </a>  
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-12">
                <div class="card11 card-1 itemBox 2022" >
                    <a href="assets/doc/Financial_Results/Covering Letter_Reg 52_Financial Results_organized_compressed.pdf" target="_blank" style="text-decoration: none;" rel="noopener">
                        <h5 class="txtshadow zoom-in">ISO REGISTRATION</h5>
                    </a>  
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-12">
                <div class="card11 card-1 itemBox 2022" >
                    <a href="assets/doc/Financial_Results/Covering Letter_Reg 52_Financial Results_organized_compressed.pdf" target="_blank" style="text-decoration: none;" rel="noopener">
                        <h5 class="txtshadow zoom-in">FORMATION OF COMPANIES</h5>
                    </a>  
                </div>
            </div>
